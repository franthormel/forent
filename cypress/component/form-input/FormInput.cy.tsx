	...
	describe("date", () => {
		it("should display correct UI", () => {
			...
			cy.get('[data-cy="form-input-optional"]')
				.should('not.exist')
			cy.get('[data-cy="form-input-error"]')
				.should('not.exist')
		})
		...
		it("should display correct UI when it contains an error", () => {
			...
			cy.get('[data-cy="form-input-error"]')
				.should('exist')
				.and('be.visible')
				.and('have.text', "Invalid Due Date")
		})
	...
	describe("number", () => {
		...
		it("should display correct UI when it contains an error", () => {
			cy.mount(<FormInput
				...
				name="numChairs"
				defaultValue={3}
				errorMessage="No chairs are available."
				dataCy="form-input"
				dataCyLabel="form-input-label"
				dataCyOptional="form-input-optional"
				dataCyError="form-input-error"
			...
			cy.get('[data-cy="form-input-label"]')
				.should('exist')
				.and('be.visible')
				.and('have.text', 'Number of Chairs')
			cy.get('[data-cy="form-input"]')
				.should('exist')
				.and('be.visible')
				.and('have.attr', 'name')
				.and('include', 'numChairs')
			cy.get('[data-cy="form-input"]')
				.should('have.attr', 'required')
			cy.get('[data-cy="form-input"]')
				.and('have.attr', 'value')
			...
			cy.get('[data-cy="form-input-error"]')
				.should('exist')
				.and('be.visible')
				.and('have.text', 'No chairs are available.')
		})
	...
	describe("text", () => {
		...
		it("should display correct UI when it contains an error", () => {
			...
			cy.get('[data-cy="form-input-label"]')
				.should('exist')
				.and('be.visible')
				.and('have.text', 'Favorite Musician')
			cy.get('[data-cy="form-input"]')
				.should('exist')
				.and('be.visible')
				.and('have.attr', 'name')
				.and('include', 'favMusician')
			cy.get('[data-cy="form-input"]')
				.should('have.attr', 'required')
			cy.get('[data-cy="form-input-optional"]')
				.should('not.exist')
