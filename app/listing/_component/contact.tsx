...
export default function ListingPageContact(props: ListingPageContactProps) {
    return (
        <div className="grid auto-rows-auto gap-y-4" data-cy={props.dataCy ?? "listing-contact"}>
            <SectionHeaderIcon props={{ text: "Contact", dataCy: "section-header-icon-contact" }}>
            ...
            <div className="flex items-end gap-x-8" data-cy={props.dataCyValues ?? "listing-contact-values"}>
                {
                    props.name &&
